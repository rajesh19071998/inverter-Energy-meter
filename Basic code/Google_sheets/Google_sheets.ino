...
void loop() {
  ...
  h =11;// dht.readHumidity();                                              // Reading temperature or humidity takes about 250 milliseconds!

  t = 22;//dht.readTemperature();                                           // Read temperature as Celsius (the default)
